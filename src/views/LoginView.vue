        ...
        <div class="form-container mt-3">
          ...
          <form v-else @submit.prevent="handleRegister">
            <div class="form-group">
              ...
              <input type="text" v-model="registerFirstName" id="registerFirstName" required />
            </div>
            <div class="form-group">
              <label for="registerLastName">Last Name</label>
              <input type="text" v-model="registerLastName" id="registerLastName" required />
            </div>
            <div class="form-group">
              <label for="registerPhoneNumber">Phone Number</label>
              <input type="text" v-model="registerPhoneNumber" id="registerPhoneNumber" required />
            </div>
            <div class="form-group">
          ...
          <p class="toggle">
            ...
            <a href="#" @click.prevent="toggleForm">{{ hasAccount ? 'Register' : 'Login' }}</a>
          </p>
        </div>
      </div>
    </div>
...
<style scoped>
.content {
  background: url(https://github.com/caleb-okkers/vv-royale-assets/blob/main/pexels-chaitaastic-1797161.jpg?raw=true) no-repeat center center fixed;
